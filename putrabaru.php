	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main table-responsive">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Data Santri Putra Baru</li>
			</ol>
		</div><!--/.row-->
		<br>
		<div class="row">
					...
					<div class="panel-body ">
                        ...
                        <table class="table tablesorter " id="">
								...
								//jika tidak ada pencarian, default yang dijalankan query ini
									$query = "SELECT * FROM mahasiswa WHERE statuss='Santri Baru' AND jk='Laki - Laki'";
								}
								...
								<td>
									<a href="putrabaru.php?show&id=<?= $row['id'] ?>" class="btn btn-primary btn-sm">Show</a>
									<a href="putrabaru.php?edit&id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>

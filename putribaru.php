	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main table-responsive">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Data Santri Putri Baru</li>
			</ol>
		</div><!--/.row-->
		<br>
		<div class="row">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<form role="search" class="pull-right">
							<div class="form-group">
								<input type="text" class="form-control " placeholder="Cari Data Santri Baru" name="kata_cari">
							</div>
						</form>
					</div>
					<div class="panel-body">
                        ...
                        <table class="table tablesorter " id="">
								...
								$query = "SELECT * FROM mahasiswa WHERE first_name like '%".$kata_cari."%' AND statuss='Santri Baru' AND jk='Perempuan'";
								} else {
								//jika tidak ada pencarian, default yang dijalankan query ini
									$query = "SELECT * FROM mahasiswa WHERE statuss='Santri Baru' AND jk='Perempuan'";
								}
								...
								<td>
									<a href="putribaru.php?show&id=<?= $row['id'] ?>" class="btn btn-primary btn-sm">Show</a>
									<a href="putribaru.php?edit&id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>

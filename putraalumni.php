	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main table-responsive">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Data Alumni Santri Putra</li>
			</ol>
		</div><!--/.row-->
		<br>
		<div class="row">
                            ...
                            <div class="mask" style="background-image: linear-gradient(to right, #30a5ff , #8ad9db);">
                                <div class="text-center p-5">
                                    ...
                                    <div class="avatar p-1"><img class="../img-thumbnail shadow-2-strong"
                                            src="uploads/<?= $data['photo'] ?>img/logo.png" width="160" height="160" /></div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
                        ...
                        <table class="table tablesorter " id="">
								...
								$query = "SELECT * FROM mahasiswa WHERE statuss='Alumni' ".$kata_cari."%' AND statuss='Alumni' AND jk='Laki - Laki'";
								} else {
								...
								<td>
									<a href="putraalumni.php?show&id=<?= $row['id'] ?>" class="btn btn-primary btn-sm">Show</a>
									<a href="putraalumni.php?edit&id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>

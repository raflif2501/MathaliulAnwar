	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main table-responsive">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Data Santri Putra Lama</li>
			</ol>
		</div><!--/.row-->
		<br>
		<div class="row">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
                        ...
                        <table class="table tablesorter " id="">
								...
								$query = "SELECT * FROM mahasiswa WHERE first_name like '%".$kata_cari."%' AND statuss='Santri Lama' AND jk='Laki - Laki'";
								} else {
								//jika tidak ada pencarian, default yang dijalankan query ini
									$query = "SELECT * FROM mahasiswa WHERE statuss='Santri Lama' AND jk='Laki - Laki'";
								}
								...
								<td>
									<a href="putralama.php?show&id=<?= $row['id'] ?>" class="btn btn-primary btn-sm">Show</a>
									<a href="putralama.php?edit&id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
